...
(function() {
  ...
  module.exports.ConfigVars = (function() {
    function ConfigVars() {
      this.put_config_vars = bind(this.put_config_vars, this);
      this.get_config_vars = bind(this.get_config_vars, this);
      this.delete_config_var = bind(this.delete_config_var, this);
    }
